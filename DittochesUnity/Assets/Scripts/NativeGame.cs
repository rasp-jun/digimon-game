...
public sealed class NativeGame : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        difficulty=PlayerPrefs.GetInt("nativeDifficulty",1); legend=PlayerPrefs.GetInt("nativeLegend",0);
        ResetGame();
    }
    ...
    private void Save(){PlayerPrefs.SetInt("nativeDifficulty",difficulty);PlayerPrefs.SetInt("nativeLegend",legend);PlayerPrefs.SetInt("nativeRound",round);PlayerPrefs.SetInt("nativeGold",gold);PlayerPrefs.SetInt("nativeHp",hp);PlayerPrefs.SetInt("nativeLevel",level);PlayerPrefs.SetInt("nativeXp",xp);PlayerPrefs.SetInt("nativeShopLocked",shopLocked?1:0);PlayerPrefs.Save();}
}
